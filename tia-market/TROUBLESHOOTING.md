...
📱 Mobile: http://192.168.88.29:3001
```
...
```typescript
const YOUR_COMPUTER_IP = 'VOTRE_NOUVELLE_IP'; // Ex: '192.168.88.29'
```

#### 3. Tester la connexion depuis votre téléphone
1. Ouvrez Chrome sur votre téléphone
2. Allez à : `http://192.168.88.29:3001/api/test`
...
3. Testez avec Postman ou curl :
   ```bash
   curl http://192.168.88.29:3001/api/test
   ```
