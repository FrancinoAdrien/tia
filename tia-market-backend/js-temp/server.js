...
app.listen(PORT, HOST, () => {
    ...
    console.log(`📱 Mobile: http://192.168.88.251:${PORT}`);
    console.log('='.repeat(60));
    console.log('🔗 Endpoints:');
    console.log(`   🔍 Test: http://192.168.88.251:${PORT}/api/test`);
    console.log(`   📝 Register: POST http://192.168.88.251:${PORT}/api/register`);
    console.log(`   🔑 Login: POST http://192.168.88.251:${PORT}/api/login`);
    console.log('='.repeat(60));
    console.log('📱 Pour tester depuis votre téléphone:');
    console.log(`   1. Ouvrez Chrome sur votre téléphone`);
    console.log(`   2. Allez à: http://192.168.88.251:${PORT}/api/test`);
